When(/^I am On Root Page Of Home Index premium with coupen\.$/) do
   b = Watir::Browser.new 
  ...
  b.text_field(:id=>"user_email").set("kedar146@gmail.com")
  ...
  b.text_field(:id=>"coupen").set("MSSYBFCYSCVOKPMSHSKAADUOESABCFNLKKNROFATMWIVJUYMDW")
  b.button(:id => 'startmigration_button').click
